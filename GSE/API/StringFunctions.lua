...
function GSE.StripControlandExtendedCodes( str )
  ...
  for i = 1, str:len() do
    ...
    elseif str:byte(i) == 13 then -- leave line breaks windows style
      -- Just keep the \r itself; the \n that normally follows it in a
      -- Windows CRLF gets kept on the next iteration by the byte==10
      -- branch above, same as it would for a lone unix-style \n.
      s = s .. str:sub(i,i)
